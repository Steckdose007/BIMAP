...
class ImageDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self,i):
        ...
        x_t = x_t.numpy()
        return dict(original_image= Image.fromarray(x_t), edit_prompt= label, edited_image= Image.fromarray(image_array))
...
if __name__ == "__main__":
    ...
    dataset_test.save_to_disk('dataset_hugg')
    # dataset_name = "lol_ok"
    print("finished")
